 ...
 * in this package. A future release if and when the NoMagicHTTP project becomes
 * modularized may change the location.<p>
 * 
 ...
 * expose methods for accessing the event emitter and other meta data, this
 * would have reduced type flexibility and increased garbage. Instead, the
 * emitter is encouraged to pass constants representing the event with arbitrary
