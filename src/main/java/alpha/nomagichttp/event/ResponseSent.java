 ...
 * 
 * The intended purpose of this event is to gather metrics. One metric that may
 * be of interest should be how many 505 (HTTP Version Not Supported) responses
 * are sent (see {@link HttpVersionTooNewException}). Too many of these and the
 * application developer ought to file a NoMagicHTTP GitHub issue.<p>
 * 
